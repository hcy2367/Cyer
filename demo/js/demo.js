...
$.event.add(window, "load", function() {
    ...
    $("#btn1").bind("click", function() {
        $("#para2").append($("#para")[0]);
        $("#para4").append($("#para3")[0]);
        //$(document.body || document.documentElement).append(para3);
    });
    $("#btn2").bind("click", function() {
        $(".para2").append("<strong class='important'>important</strong>");
    });  
    //prepend
     $("#btn3").bind("click", function() {
        $("#para9").prepend($("#para10")[0]);
        $("#para11").prepend($("#para12")[0]);
    });
    $("#btn4").bind("click", function() {
        $(".para4").prepend("<strong class='important'>important</strong>");
    }); 
    //before
     $("#btn5").bind("click", function() {
        $("#para17").before($("#para18")[0]);
    });
    $("#btn6").bind("click", function() {
        $(".para6").before("<strong class='important'>important</strong>");
    }); 
    //after
     $("#btn7").bind("click", function() {
        $("#para22").after($("#para21")[0]);
    });
    $("#btn8").bind("click", function() {
        $(".para8").after("<strong class='important'>important</strong>");
    });     
